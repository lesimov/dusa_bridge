...
-- lib.addKeybind({
--     name = 'right_click_interact',
--     description = 'Right Click Interact',
--     defaultKey = 'MOUSE_RIGHT', -- MOUSE_RIGHT
--     onPressed = function(self)
--         print('SAĞ TIK')
--         if not pressed then return end
--         pressed = false
